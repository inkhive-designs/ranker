...
function ranker_sanitize_checkbox( $input ) {
    if ( $input == 1 ) {
        return 1;
    } else {
        return '';
...
function ranker_sanitize_positive_number( $input ) {
...
function ranker_sanitize_category( $input ) {
...
function ranker_sanitize_product_category( $input ) {
